...
bot.on(['/help'], (msg) => {
    ...
    str += "<code>";
    str += "/ranking\n"
    str += util.rightJustify("Retorna ranking geral da atual temporada\n", 4);
    str += "/ranking [semana]"
    str += util.rightJustify("Retorna ranking da semana escolhida\n", 4);
    str += "/placar"
    str += util.rightJustify("Retorna placar da atual semana\n", 4);
    str += "/placar [semana]"
    str += util.rightJustify("Retorna placar da semana escolhida\n", 4);
    str += "/placar_mini"
    str += util.rightJustify("Retorna placar da atual semana (versão mobile)\n", 4);
    str += "/placar_mini [semana]"
    str += util.rightJustify("Retorna placar da semana escolhida (versão mobile)\n", 4);
    str += "/belt"
    str += util.rightJustify("Retorna um gif do Aaron Rodgers fazendo a comemoração cinturão\n", 4);
    str += "/hailmary"
    str += util.rightJustify("Retorna um gif da Hail Mary contra Detroit (Milagre de Detroit)\n", 4);
    str += "</code>";
